...
function go(s) { screen = s; document.body.classList.toggle('web-mode', s === 'reporteWeb' || s === 'validacionWeb'); render(); document.querySelector('#app')?.scrollTo(0, 0); }
...
function render() { ({ login, loading, modulos, home, maestra, registro, nuevo, detalle, reportes, reporteDetalle, indicadores, envio, reporteWeb, validacionWeb }[screen] || login)(); }
